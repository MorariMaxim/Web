...
waitForCondition(() => {
  const element1 = document.getElementsByClassName("unlogged-header");
  const element2 = document.getElementsByClassName("logged-header");
  const element1Exists = element1.length == 1;
  const element2Exists = element2.length == 1;
